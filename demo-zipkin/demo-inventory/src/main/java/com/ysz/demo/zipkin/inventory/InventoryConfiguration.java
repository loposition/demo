 ...
 */
@EnableWebMvc
@ComponentScan("com.ysz.demo.zipkin.inventory")
public class InventoryConfiguration extends WebMvcConfigurerAdapter {
  ...
  public Tracing tracing() {
    return Tracing.newBuilder()
        .localServiceName("inventory")
        .propagationFactory(ExtraFieldPropagation.newFactory(B3Propagation.FACTORY, "inventory"))
